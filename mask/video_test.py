...
if __name__ == '__main__':
    ...
    capture = cv2.VideoCapture("C:/Users/Admin/anaconda3/envs/test/Mask_RCNN/4초.mp4")
    ...
    out = cv2.VideoWriter('4초.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame_width,frame_height))
